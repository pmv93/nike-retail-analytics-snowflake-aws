...
UNION ALL
SELECT 3, 'Air Zoom Pegasus 40', 'Nike Running', 'Footwear', 'Running', 60.00, 140.00, 'https://static.nike.com/a/images/t_PDP_1280_v1/pegasus-40.png', PARSE_JSON('{"material": "flyknit", "color": "black"}')
UNION ALL
SELECT 4, 'Metcon 9', 'Nike Training', 'Footwear', 'Training', 65.00, 150.00, 'https://static.nike.com/a/images/t_PDP_1280_v1/metcon-9.png', PARSE_JSON('{"material": "synthetic", "color": "gray"}')
UNION ALL
SELECT 5, 'Air Jordan 1 Low', 'Nike Jordan', 'Footwear', 'Basketball', 50.00, 120.00, 'https://static.nike.com/a/images/t_PDP_1280_v1/jordan-1-low.png', PARSE_JSON('{"material": "leather", "color": "bred"}')
UNION ALL
SELECT 6, 'Tech Fleece Hoodie', 'Nike Tech', 'Apparel', 'Hoodies', 40.00, 100.00, 'https://static.nike.com/a/images/t_PDP_1280_v1/tech-fleece.png', PARSE_JSON('{"material": "fleece", "color": "black"}')
UNION ALL
SELECT 7, 'Dunk Low', 'Nike SB', 'Footwear', 'Lifestyle', 45.00, 130.00, 'https://static.nike.com/a/images/t_PDP_1280_v1/dunk-low.png', PARSE_JSON('{"material": "leather", "color": "panda"}');
